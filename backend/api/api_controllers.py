...
def setup_routes(app: Flask, client: MongoClient): 
    ...
    @app.route('/api/pdf/listar', methods=['GET'])
    def list_pdfs():
        '''
    ...
    @app.route('/api/relatorios/templates/download', methods=['GET'])
    ...
    @app.route('/api/instrumento/listar', methods=['GET'])
    ...
    @app.route('/api/instrumento/<string:instrumento>/introducao/download', methods=['GET'])
    ...
    @app.route('/api/instrumento/<string:instrumento>/conclusao/download', methods=['GET'])
    ...
    @app.route('/api/instrumento/<string:instrumento>/introducao/substituir', methods=['POST'])
    ...
    @app.route('/api/instrumento/<string:instrumento>/conclusao/substituir', methods=['POST'])
