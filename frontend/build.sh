...
podman push sistema-frontend:$version quay.io/uemcpa/sistema-frontend:$version
podman push sistema-frontend:latest quay.io/uemcpa/sistema-frontend:latest