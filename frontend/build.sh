...
podman push sistema-frontend:$version quay.io/uemcpa/sistema-frontend:$version --auth=../auth.json
podman push sistema-frontend:latest quay.io/uemcpa/sistema-frontend:latest --auth=../auth.json